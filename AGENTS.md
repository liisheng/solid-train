...
- 2026-09-05: This repository is a Python 3.11 language-model training project. The root
  `Dockerfile` provides a CPU verification environment for installation and tests; RTX/CUDA
  training continues to use the separately verified Windows CUDA environment documented in
  `docs/ENVIRONMENT.md` until a GPU-container lock is measured and recorded.
