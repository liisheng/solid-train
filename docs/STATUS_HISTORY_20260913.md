# Status history archived 2026-09-13

Historical coordination entries below preserve prior milestone context.
They contain superseded statuses, branch names and launch instructions. Use
[current status](STATUS.md) and the [documentation index](README.md) for next actions.

## Original status log

2026-09-13T01:51+08:00: [Competitiveness plan](experiments/COMPETITIVENESS_PLAN.md)
drafted at user request. One fresh3B candidate after larger/cleaner data qualification,
dev-only selection and one final benchmark comparison. PROPOSAL ONLY; no new job,
active scope amendment or approval inferred. G6 release state below unchanged.

2026-09-13T01:23+08:00: [G6 full provisional results](g6/RESULTS.md) verified;
all five trusted splits/document IDs covered, root bundle recheck PASS. Outer192.305s,
harness99.558s. Fresh environment PASS supersedes setup path lookup failure.
No running evaluation remains. G6 release BLOCKED on official settings/harness
provenance/public accessibility/human approvals. No training/commit/push/publication.

2026-09-13T01:17+08:00: G6 authorized.
[G6 handoff](g6/README.md): fresh CUDA environment setup and full-evaluation
controller dispatched in `runs/verification/g6/20260913-01`. Inspect live receipts
before relaunch. Fixed full-run sample-record omission; Docker build/Ruff PASS,
76 evaluation tests PASS, Windows17 coverage tests PASS. No scores yet; G6 NOT_PASS.
User observes long jobs. Official settings/provenance/public assets/release approvals remain.

2026-09-12T23:16+08:00: [Generation diagnostic](g5/GENERATION_DIAGNOSTIC.md)
reproduces poor generation across four prompts. Export/checkpoint/tokenizer identity
checks pass; eight data spot checks show readable tokens and next-token learning.
No obvious inference defect found; model-quality cause remains unresolved. G5
completion stands, G6 NOT_RUN; conversational usefulness is not established.
