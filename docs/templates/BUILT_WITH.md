...
Pinned in `configs/data/sources_v4.yaml`. These rows are facts, not placeholders — copy them
...
| HuggingFaceFW/fineweb | `9bb295ddab0e05d785b879661af7260fed5140fc` | ODC-By 1.0 | 20% stable |
| open-web-math/open-web-math | `fde8ef8de2300f5e778f56261843dab89f230815` | ODC-By 1.0 | 7% stable + reserved math prose |
| sedthh/gutenberg_english | `28973b04f28fd7be4a6186a042bc26159d4366ca` | MIT | 3% stable narrative |
...
FineWeb-Edu, FineWeb, and OpenWebMath all derive from Common Crawl; also observe the
